...
''' </summary>
''' <remarks></remarks>
Partial Class Graph_WLTimeChart
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim test As String '= "<%$RouteValue:LoggerID%>"

        If Page.RouteData.Values("LoggerID") Is Nothing Then
            test = "All locales"
        Else
            test = Page.RouteData.Values("LoggerID").ToString()
        End If

        Me.LblDateSpan.InnerText = test
