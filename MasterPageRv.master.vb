...
Partial Class MasterPageRv
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If LoginStatus = 0 Then
            System.Threading.Thread.Sleep(2000)                                                     ' 2010/06/01 Kino Add 再取得確認
        ...
        SiteName = Session.Item("SN")                           '事務所名
        SiteDirectory = Session.Item("SD")                      '現場ディレクトリ
        IDNo = Session.Item("IDNm")                             '識別番号

        'Me.Lit1.Text = SiteName.Trim
        Me.Lit1.InnerText = SiteName.Trim
    ...
    '            DbDa3 = New OleDb.OleDbDataAdapter(strSQL, DbCon)
    ...
    '                        linkButton = New HyperLink 'Button
    ...
    Protected Sub TScMan1_AsyncPostBackError(ByVal sender As Object, ByVal e As System.Web.UI.AsyncPostBackErrorEventArgs) Handles TScMan1.AsyncPostBackError
        ...
        Dim sw As New IO.StreamWriter(Server.MapPath("~/log/errorAsync_" & Date.Now.ToString("yyMM") & ".log"), True, Encoding.GetEncoding("Shift_JIS"))
