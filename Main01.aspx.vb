...
Partial Class Main01
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ''    OpenString = "<script type='text/javascript' src='js/jquery.js'></script>"
        ''    OpenString += "<script type='text/javascript' src='js/jquery.dimensions.js'></script>"
        ''    OpenString += "<script type='text/javascript' src='js/jquery.tooltip.js'></script>"
        ''    OpenString += "<script type='text/javascript'>"
        ''    OpenString += "$( function(){"
        ''    OpenString += "    $.Tooltip.defaults = $.extend( $.Tooltip.defaults, {"
        ''    OpenString += "        delay      : 1,"
        ''    OpenString += "        showURL    : false,"
        ''    OpenString += "        showBody:   ' - ',"
        ''    OpenString += "        left       : -100,"
        ''    OpenString += "        track      : true    });"
        ''    OpenString += "});"
        ''    OpenString += "<" + "/SCRIPT>"
        ''    Page.ClientScript.RegisterStartupScript(Me.GetType(), "Main", OpenString)
        ''End If
        '' ''====================================
        ...
        ''    'OpenString += "<" + "/SCRIPT>"
        ''    'OpenString = ""
        ''    'Page.ClientScript.RegisterStartupScript(Me.GetType(), "Main01", OpenString)
        ...
        End If
        'Dim aa As String = Page.FindControl("mnust").ToString
        ...
        If iframeSrc Is Nothing OrElse iframeSrc.Trim.Length = 0 Then
            ...
            Me.litoutimg.Visible = False
            Me.litoutimg.Dispose()
            Me.litoutimg = Nothing
        Else
            Dim sz() As String = iframeSrc.Split(","c)
            'Me.litoutimg.Text = "<iframe frameborder='none' width='" & sz(1) & "' height='" & sz(2) & "' name='outimg' src='" & sz(0) & "' seamless></iframe>"
            Me.litoutimg.Text = String.Format("<iframe frameborder='0' width='{1}' height='{2}' name='outimg' src='{0}' seamless></iframe>", sz)
        ...
        Me.TmrCheckNewData.Enabled = False
