<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Graph_TimeChart.aspx.vb" Inherits="Graph_TimeChart" Culture="ja-JP" %>
...
<body>
	...
	<div id="FrmGraphTimeChart" lang="ja">
		...
		<asp:Panel ID="PnlNoPrint" runat="server" CssClass="dspOnly" Width="656px" EnableTheming="True" Wrap="False" BorderStyle="None" HorizontalAlign="Center">
			...
			<asp:Panel ID="Ph1" runat="server" CssClass="accordionHeader" EnableViewState="False">
				...
				<asp:ImageButton ID="ImgCollExp" runat="server" EnableTheming="False" 
					EnableViewState="False" BorderStyle="None" CssClass="collapseImgButton" ImageUrl="~/img/el.png" />
				<asp:Label ID="LblColl1" runat="server" Font-Size="Small" ForeColor="Gold" BorderStyle="None" />
			</asp:Panel>
			<asp:Panel ID="PnlGraphSet" runat="server" BackColor="White" BorderStyle="None" CssClass="collapsePanel" EnableTheming="False" Width="654px" HorizontalAlign="Center" Wrap="False" Height="1200px">
						...
						<td class="tableContent" style="padding-top: 10px; padding-bottom: 10px">
							<table id="showparameta" style="width: 100%; text-align: left; border-spacing: 2px;font-size:9pt;">
								<tr>
									...
									<td style="width: 12%">
										<asp:DropDownList ID="DdlTitlePosition" runat="server" Font-Size="9pt" 
											Width="60px">
								...
								<tr>
									...
									<td>
										<asp:DropDownList ID="DdlPaperOrientation" runat="server" DataTextField="用紙方向" 
											DataValueField="用紙方向" Font-Bold="False" Font-Size="9pt" Width="95px">
										</asp:DropDownList>
									</td>
									<td>■グラフ色指定</td>
									<td>
				...
				<table class="tableOutline" id="tableScale">
					...
					<tr id="r3" runat="server">
						<td class="tableLabelNo tableBorderTop">
							<asp:Label ID="LblNo3" runat="server" Text="No.3"></asp:Label>
							<div runat="server" id="svOut3" class="saveBtnOut"><asp:LinkButton ID="lkBtn3" runat="server" CssClass="saveBtn">保存</asp:LinkButton></div>
						</td>
						<td class="tableChartSet tableBorderTop">
							<asp:panel ID="Pnl3" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNo31" runat="server" GroupName="No3" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScale3" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNo32" runat="server" GroupName="No3" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label7" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMax3" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label8" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMin3" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
						<td class="tableChartSet tableBorderTop tableBorderLeft">
							<asp:panel ID="PnlR3" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNoR31" runat="server" GroupName="No3R" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScaleR3" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNoR32" runat="server" GroupName="No3R" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label23" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMaxR3" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label24" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMinR3" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
					</tr>
					<tr id="r4" runat="server">
						<td class="tableLabelNo tableBorderTop">
							<asp:Label ID="LblNo4" runat="server" Text="No.4"></asp:Label>
							<div runat="server" id="svOut4" class="saveBtnOut"><asp:LinkButton ID="lkBtn4" runat="server" CssClass="saveBtn">保存</asp:LinkButton></div>
						</td>
						<td class="tableChartSet tableBorderTop">
							<asp:panel ID="Pnl4" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNo41" runat="server" GroupName="No4" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScale4" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNo42" runat="server" GroupName="No4" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label9" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMax4" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label10" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMin4" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
						<td class="tableChartSet tableBorderTop tableBorderLeft">
							<asp:panel ID="PnlR4" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNoR41" runat="server" GroupName="No4R" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScaleR4" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNoR42" runat="server" GroupName="No4R" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label25" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMaxR4" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label26" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMinR4" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
					</tr>
					<tr id="r5" runat="server">
						<td class="tableLabelNo tableBorderTop">
							<asp:Label ID="LblNo5" runat="server" Text="No.5"></asp:Label>
							<div runat="server" id="svOut5" class="saveBtnOut"><asp:LinkButton ID="lkBtn5" runat="server" CssClass="saveBtn">保存</asp:LinkButton></div>
						</td>
						<td class="tableChartSet tableBorderTop">
							<asp:panel ID="Pnl5" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNo51" runat="server" GroupName="No5" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScale5" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNo52" runat="server" GroupName="No5" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label1" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMax5" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label2" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMin5" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
						<td class="tableChartSet tableBorderTop tableBorderLeft">
							<asp:panel ID="PnlR5" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNoR51" runat="server" GroupName="No5R" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScaleR5" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNoR52" runat="server" GroupName="No5R" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label27" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMaxR5" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label28" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMinR5" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
					</tr>
					<tr id="r6" runat="server">
						<td class="tableLabelNo tableBorderTop">
							<asp:Label ID="LblNo6" runat="server" Text="No.6"></asp:Label>
							<div runat="server" id="svOut6" class="saveBtnOut"><asp:LinkButton ID="lkBtn6" runat="server" CssClass="saveBtn">保存</asp:LinkButton></div>
						</td>
						<td id="lf6" runat="server" class="tableChartSet tableBorderTop">
							<asp:panel ID="Pnl6" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNo61" runat="server" GroupName="No6" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScale6" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNo62" runat="server" GroupName="No6" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label11" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMax6" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label12" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMin6" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
						<td class="tableChartSet tableBorderTop tableBorderLeft">
							<asp:panel ID="PnlR6" runat="server" cssClass="ChartSetPanel">
								<asp:RadioButton ID="RdbNoR61" runat="server" GroupName="No6R" Text="既定" BorderStyle="None" />
								<asp:DropDownList ID="DdlScaleR6" runat="server" Width="89px"></asp:DropDownList><br />
								<asp:RadioButton ID="RdbNoR62" runat="server" GroupName="No6R" Text="入力" BorderStyle="None" />
								<asp:Label ID="Label29" runat="server" Text="最大" CssClass="ChartlblMax"></asp:Label>
								<asp:TextBox ID="TxtMaxR6" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
								<asp:Label ID="Label30" runat="server" Text="～最小" CssClass="ChartlblMin"></asp:Label>
								<asp:TextBox ID="TxtMinR6" runat="server" CssClass="TEXTBOXES txtScale"></asp:TextBox>
							</asp:panel>
						</td>
					</tr>
				</table>
			...
			<asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" CollapseControlID="Ph1" Collapsed="true" CollapsedText="設定表示" ExpandControlID="Ph1"
				ExpandedText="設定非表示" TargetControlID="PnlGraphSet" TextLabelID="LblColl1" Enabled="True" EnableViewState="False" CollapsedImage="~/img/el.png" ExpandedImage="~/img/cl.png" ImageControlID="ImgCollExp" SuppressPostBack="True">
		...
		<asp:Panel runat="server" ID="GraphOuter">
		<asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="False" UpdateMode="Conditional" EnableViewState="False">
		  <ContentTemplate>
		  <asp:Label ID="LblTitleUpper" runat="server" BorderStyle="None" 
				  CssClass="titleUpper" EnableTheming="True" EnableViewState="False" 
				  Width="650px" BorderWidth="0px"></asp:Label>
			  <div><asp:Label ID="LblDateSpan" runat="server" CssClass="lblDateSpan" EnableTheming="True"></asp:Label></div>
			...
			<C1WebChart:C1WebChart ID="WC1" runat="server" AlternateText="Graph1" 
				...
				LastDesignUpdate="636639827261412578" Visible="False" Width="650px" 
					  ImageQuality="100" OnDrawDataSeries="WC1_DrawDataSeries">
...
&lt;/Chart2DPropBag&gt;" /></C1WebChart:C1WebChart>
		...
		<asp:Panel ID="PnlGraph2" runat="server" Height="153px" Width="650px" Visible="False" EnableTheming="True" EnableViewState="False" BorderStyle="None" BorderWidth="0px">
				  <C1WebChart:C1WebChart ID="WC2" runat="server" Height="153px"
					  LastDesignUpdate="636639827241490703" Width="650px" AlternateText="Graph2" 
					  CallbackWaitImageUrl="~/img/redraw.gif" EnableCallback="False" Enabled="False" 
					  EnableTheming="True" EnableViewState="False" ImageQuality="100" 
					  Visible="False">
					  <Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;Chart2DPropBag Version=&quot;4.0.20122.22206&quot;&gt;
  &lt;StyleCollection&gt;
...
&lt;/Chart2DPropBag&gt;" />
		...
		<asp:Panel ID="PnlGraph3" runat="server" Height="153px" Width="650px" Visible="False" EnableTheming="True" EnableViewState="False" BorderStyle="None" BorderWidth="0px">
		<C1WebChart:C1WebChart ID="WC3" runat="server" Height="153px" Width="650px" 
				CallbackWaitImageUrl="~/img/redraw.gif" Visible="False" EnableTheming="True" 
				Enabled="False" AlternateText="Graph3" EnableViewState="False" 
				EnableCallback="False" OnDrawDataSeries="WC1_DrawDataSeries" 
				LastDesignUpdate="636639789090031563" ImageQuality="100" >
			<Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
...
&lt;/Chart2DPropBag&gt;" /></C1WebChart:C1WebChart>
		...
		<asp:Panel ID="PnlGraph4" runat="server" Height="153px" Width="650px" Visible="False" EnableTheming="True" EnableViewState="False" BorderStyle="None" BorderWidth="0px">
		<C1WebChart:C1WebChart ID="WC4" runat="server" Height="153px" Width="650px" 
				CallbackWaitImageUrl="~/img/redraw.gif" Visible="False" EnableTheming="True" 
				Enabled="False" AlternateText="Graph4" EnableViewState="False" 
				EnableCallback="False" OnDrawDataSeries="WC1_DrawDataSeries" 
				LastDesignUpdate="636639815196005859" ImageQuality="100" >
			<Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;Chart2DPropBag Version=&quot;4.0.20112.21131&quot;&gt;
  &lt;StyleCollection&gt;
	&lt;NamedStyle Name=&quot;Legend&quot; ParentName=&quot;Legend.default&quot; StyleData=&quot;AlignHorz=General;AlignImage=Center;AlignVert=Top;BackColor=White;Border=None,Black,2;ForeColor=Black;Opaque=True;Rotation=Rotate0;Wrap=True;Rounding=1 1 1 1;&quot; /&gt;
  ...
  &lt;VisualEffectsData&gt;45,1,0.6,0.1,0.5,0.9,0,0,0.15,0,0,1,0.5,-25,0,0,0,1,64,1;Group1=45,1,0.6,0.1,0.5,0.9,0,0,0.15,0,0,1,0.5,-25,0,0,0,1,64,1;Group0=45,1,0.6,0.1,0.5,0.9,0,0,0.15,0,0,1,0.5,-25,0,0,0,1,64,1&lt;/VisualEffectsData&gt;
&lt;/Chart2DPropBag&gt;" /></C1WebChart:C1WebChart>
		</asp:Panel><asp:Panel ID="PnlGraph5" runat="server" Height="153px" Width="650px" Visible="False" EnableTheming="True" EnableViewState="False" BorderStyle="None" BorderWidth="0px">
		<C1WebChart:C1WebChart ID="WC5" runat="server" Height="153px" Width="650px" 
					  CallbackWaitImageUrl="~/img/redraw.gif" Visible="False" EnableTheming="True" 
					  Enabled="False" AlternateText="Graph5" EnableViewState="False" 
					  EnableCallback="False" OnDrawDataSeries="WC1_DrawDataSeries" 
					  LastDesignUpdate="636639774489911016" ImageQuality="100" >
			<Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;Chart2DPropBag Version=&quot;4.0.20112.21131&quot;&gt;
  &lt;StyleCollection&gt;
	&lt;NamedStyle Name=&quot;LabelStyleDefault.default&quot; ParentName=&quot;Control&quot; StyleData=&quot;BackColor=Transparent;Border=None,Transparent,1;&quot; /&gt;
...
&lt;/Chart2DPropBag&gt;" /></C1WebChart:C1WebChart>
		...
		<asp:Panel ID="PnlGraph6" runat="server" Height="153px" Width="650px" Visible="False" EnableTheming="True" EnableViewState="False" BorderStyle="None" BorderWidth="0px">
		<C1WebChart:C1WebChart ID="WC6" runat="server" Height="153px" Width="650px" 
				CallbackWaitImageUrl="~/img/redraw.gif" Visible="False" EnableTheming="True" 
				Enabled="False" AlternateText="Graph6" EnableViewState="False" 
				EnableCallback="False" OnDrawDataSeries="WC1_DrawDataSeries" 
				LastDesignUpdate="636639774503680547" ImageQuality="100" >
			<Serializer Value="&lt;?xml version=&quot;1.0&quot;?&gt;
&lt;Chart2DPropBag Version=&quot;4.0.20112.21131&quot;&gt;
  &lt;StyleCollection&gt;
	&lt;NamedStyle Name=&quot;LabelStyleDefault.default&quot; ParentName=&quot;Control&quot; StyleData=&quot;BackColor=Transparent;Border=None,Transparent,1;&quot; /&gt;
	...
	&lt;NamedStyle Name=&quot;PlotArea&quot; ParentName=&quot;Area&quot; StyleData=&quot;BackColor=Transparent;BackColor2=Transparent;Border=Solid,Black,1;ForeColor=Black;GradientStyle=None;HatchStyle=None;Opaque=True;&quot; /&gt;
	&lt;NamedStyle Name=&quot;AxisY&quot; ParentName=&quot;Area&quot; StyleData=&quot;AlignHorz=Near;AlignVert=Center;Font=MS UI Gothic, 9pt;ForeColor=ControlDarkDark;Rotation=Rotate270;&quot; /&gt;
	&lt;NamedStyle Name=&quot;AxisX&quot; ParentName=&quot;Area&quot; StyleData=&quot;AlignHorz=Center;AlignVert=Bottom;Font=ＭＳ Ｐゴシック, 9pt;ForeColor=ControlDarkDark;Rotation=Rotate0;&quot; /&gt;
  &lt;/StyleCollection&gt;
  &lt;ChartGroupsCollection&gt;
	&lt;ChartGroup Name=&quot;LeftAxis&quot; Use3D=&quot;False&quot;&gt;
	  &lt;DataSerializer Hole=&quot;7.7E+30&quot; DefaultSet=&quot;True&quot;&gt;
...
&lt;/Chart2DPropBag&gt;" /></C1WebChart:C1WebChart>
				...
				<asp:Label ID="LblTitleLower" runat="server" BorderStyle="None" Width="650px" 
				  BackColor="Transparent" BorderColor="Transparent" CssClass="titleLower" 
				  EnableTheming="True" EnableViewState="False" BorderWidth="0px" />
			</ContentTemplate>
			<Triggers>
		  ...
		  <asp:Timer ID="Tmr_Update" runat="server" Enabled="False" />        
				<asp:RegularExpressionValidator ID="RExValidMax1" runat="server" ControlToValidate="TxtMax1"
					CssClass="BASICSET" Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。"
					SetFocusOnError="True" ValidationExpression='^[+\-]?[0-9]{1,6}\.?[0-9]{0,5}$'></asp:RegularExpressionValidator><asp:RegularExpressionValidator
							ID="RExValidMax2" runat="server" ControlToValidate="TxtMax2" CssClass="BASICSET"
							Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
							ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
									ID="RExValidMax3" runat="server" ControlToValidate="TxtMax3" CssClass="BASICSET"
									Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
									ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator ID="RExValidMax4" runat="server" ControlToValidate="TxtMax4"
					CssClass="BASICSET" Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。"
					SetFocusOnError="True" ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
							ID="RExValidMax5" runat="server" ControlToValidate="TxtMax5" CssClass="BASICSET"
							Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
							ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
									ID="RExValidMax6" runat="server" ControlToValidate="TxtMax6" CssClass="BASICSET"
									Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$" SetFocusOnError="True"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
						ID="RExValidMin1" runat="server" ControlToValidate="TxtMin1" CssClass="BASICSET"
						Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
						ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,5}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
								ID="RExValidMin2" runat="server" ControlToValidate="TxtMin2" CssClass="BASICSET"
								Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
								ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
										ID="RExValidMin3" runat="server" ControlToValidate="TxtMin3" CssClass="BASICSET"
										Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
										ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
						ID="RExValidMin4" runat="server" ControlToValidate="TxtMin4" CssClass="BASICSET"
						Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
						ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
								ID="RExValidMin5" runat="server" ControlToValidate="TxtMin5" CssClass="BASICSET"
								Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
								ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
										ID="RExValidMin6" runat="server" ControlToValidate="TxtMin6" CssClass="BASICSET"
										Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
										ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator ID="RExValidMaxR1" runat="server" ControlToValidate="TxtMaxR1"
					CssClass="BASICSET" Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。"
					SetFocusOnError="True" ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
						ID="RExValidMaxR2" runat="server" ControlToValidate="TxtMaxR2" CssClass="BASICSET"
						Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
						ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
							ID="RExValidMaxR3" runat="server" ControlToValidate="TxtMaxR3" CssClass="BASICSET"
							Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
							ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
								ID="RExValidMaxR4" runat="server" ControlToValidate="TxtMaxR4" CssClass="BASICSET"
								Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
								ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
									ID="RExValidMaxR5" runat="server" ControlToValidate="TxtMaxR5" CssClass="BASICSET"
									Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
									ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
										ID="RExValidMaxR6" runat="server" ControlToValidate="TxtMaxR6" CssClass="BASICSET"
										Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$" SetFocusOnError="True"></asp:RegularExpressionValidator><asp:RegularExpressionValidator ID="RExValidMinR1" runat="server" ControlToValidate="TxtMinR1"
					CssClass="BASICSET" Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。"
					SetFocusOnError="True" ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
						ID="RExValidMinR2" runat="server" ControlToValidate="TxtMinR2" CssClass="BASICSET"
						Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
						ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
							ID="RExValidMinR3" runat="server" ControlToValidate="TxtMinR3" CssClass="BASICSET"
							Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
							ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
								ID="RExValidMinR4" runat="server" ControlToValidate="TxtMinR4" CssClass="BASICSET"
								Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
								ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
									ID="RExValidMinR5" runat="server" ControlToValidate="TxtMinR5" CssClass="BASICSET"
									Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
									ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator><asp:RegularExpressionValidator
										ID="RExValidMinR6" runat="server" ControlToValidate="TxtMinR6" CssClass="BASICSET"
										Display="None" EnableTheming="True" ErrorMessage="<b>入力に間違いがあります。</b><br /><br />数値(半角)のみとしてください。" SetFocusOnError="True"
										ValidationExpression="^[+\-]?[0-9]{1,6}\.?[0-9]{0,2}$"></asp:RegularExpressionValidator>
		<asp:validatorcalloutextender ID="COEMax1" runat="server"
					TargetControlID="RExValidMax1" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px">
	</asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMax2" runat="server" 
			TargetControlID="RExValidMax2" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMax3" runat="server" 
			TargetControlID="RExValidMax3" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMax4" runat="server" 
			TargetControlID="RExValidMax4" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMax5" runat="server" 
			TargetControlID="RExValidMax5" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMax6" runat="server" 
			TargetControlID="RExValidMax6" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin1" runat="server" 
			TargetControlID="RExValidMin1" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin2" runat="server" 
			TargetControlID="RExValidMin2" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin3" runat="server" 
			TargetControlID="RExValidMin3" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin4" runat="server" 
			TargetControlID="RExValidMin4" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin5" runat="server" 
			TargetControlID="RExValidMin5" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMin6" runat="server" 
			TargetControlID="RExValidMin6" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR1" runat="server" 
			TargetControlID="RExValidMaxR1" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR2" runat="server" 
			TargetControlID="RExValidMaxR2" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR3" runat="server" 
			TargetControlID="RExValidMaxR3" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR4" runat="server" 
			TargetControlID="RExValidMaxR4" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR5" runat="server" 
			TargetControlID="RExValidMaxR5" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMaxR6" runat="server" 
			TargetControlID="RExValidMaxR6" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR1" runat="server" 
			TargetControlID="RExValidMinR1" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR2" runat="server" 
			TargetControlID="RExValidMinR2" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR3" runat="server" 
			TargetControlID="RExValidMinR3" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR4" runat="server" 
			TargetControlID="RExValidMinR4" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR5" runat="server" 
			TargetControlID="RExValidMinR5" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	<asp:validatorcalloutextender ID="COEMinR6" runat="server" 
			TargetControlID="RExValidMinR6" HighlightCssClass="validatorCalloutHighligh" 
			Width="250px"></asp:validatorcalloutextender>
	  <asp:updatepanelanimationextender ID="UpdPnlAnimEx" runat="server" 
